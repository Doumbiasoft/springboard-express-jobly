...
const companiesSearchQueriesSchema = require("../schemas/companiesSearchQueries.json");
...
router.get("/", async function (req, res, next) {
  try {
    const validator = jsonschema.validate(req.query, companiesSearchQueriesSchema);
    if (!validator.valid) {
      const errs = validator.errors.map(e => e.stack);
      throw new BadRequestError(errs);
    }
